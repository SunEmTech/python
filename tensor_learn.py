...
#dose = tf.feature_column.numeric_column("dose")
#feat_col = [sex, dose]
#
#input_func = tf.estimator.inputs.numpy_input_fn(x=X_train, y=Y_train, batch_size=100, shuffle=True)
#model = tf.estimator.LinearRegressor(feature_columns=sex+dose)
